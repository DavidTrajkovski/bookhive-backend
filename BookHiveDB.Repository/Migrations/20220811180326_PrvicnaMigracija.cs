...
{
    public partial class PrvicnaMigracija : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(nullable: true),
                    bookshopEmail = table.Column<string>(nullable: true),
                    phoneNumber = table.Column<string>(nullable: true),
                    websiteLink = table.Column<string>(nullable: true),
                    latitude = table.Column<double>(nullable: false),
                    longitude = table.Column<double>(nullable: false),
                    grade = table.Column<double>(nullable: false),
                    numGraders = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookId = table.Column<Guid>(nullable: false),
                    Id = table.Column<Guid>(nullable: false),
                    lastPageRead = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
